...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-between items-center p-4 sm:p-6 px:4 absolute top-0 z-10">
      ...
      {userData ? (
        ...
        <button
          ...
          className="flex  items-center gap-2 border  border-gray-500 px-6 py-2 rounded-full text-gray-800
